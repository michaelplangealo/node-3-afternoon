...
module.exports = {
  ...
  //   This method is responsible for resetting the value cart to an empty array and total to 0. The method should then send a status of 200 with update reqest session' user object.
